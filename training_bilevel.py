...
if __name__ == "__main__":
    ...
    # Replace colons in timestamp with dashes for Windows compatibility
    timestamp_str = str(datetime.datetime.now()).replace(":", "-").replace(" ", "_")
    logging.basicConfig(
    ...
    torch.save(
        regularizer.state_dict(),
        f"weights/bilevel_{problem}/{regularizer_name}_bilevel_{hypergradient_computation}_for_{problem}_trial.pt",
    )
